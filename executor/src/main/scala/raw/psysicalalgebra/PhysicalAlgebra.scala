...
object PhysicalAlgebra {
  ...
  case class ScalaAssign(logicalAssign: Assign, as: Seq[(String, PhysicalAlgebraNode)], child: PhysicalAlgebraNode) extends ScalaNode(logicalAssign)
  case class SparkAssign(logicalAssign: Assign, as: Seq[(String, PhysicalAlgebraNode)], child: PhysicalAlgebraNode) extends SparkNode(logicalAssign)
