...
object PubsAndAuthorsSQL extends StrictLogging {
  ...
  val pubs: DataFrame = Common.newDataframeFromJSON("data/pubs-authors/publications.json", hiveContext)
  val authors: DataFrame = Common.newDataframeFromJSON("data/pubs-authors/authors.json", hiveContext)
  ...
  def main(args: Array[String]) {
    ...
    //          JOIN authors ON (authors.name = newTable.authorsExp AND authors.title = "PhD"
  }
