...
class SparkSQLFlatCSVTest extends AbstractSparkFlatCSVTest {
  ...
  ignore("bag of student birth years") {
  ...
  ignore("[DF] set of students born in 1990") {
  ...
  ignore("[SQL] set of students born in 1990") {
  ...
  ignore("[SQL] set of students in BC123") {
  ...
  ignore("[SQL] set of department (using only students table)") {
  ...
  ignore("[DF] set of department and the headcount (using only students table)") {
    //      val r = Raw.query( """
  ...
  ignore("[SQL] set of department and the headcount (using only students table)") {
    val expected = Map("dep1" -> 3, "dep2" -> 2, "dep3" -> 2)
  ...
  ignore("[DF] set of department and the headcount (using both departments and students table)") {
    //      val r = Raw.query("""
  ...
  ignore("[SQL] set of department and the headcount (using both departments and students table)") {
    val expected = Map("dep1" -> 3, "dep2" -> 2, "dep3" -> 2)
    val rows = sqlContext.sql(
      """
  ...
  //    ignore("[SQL] most studied discipline") {
  ////      val r = Raw.query("""
  ...
  ignore("[DF] most studied discipline") {
  ...
  //  ignore("list of disciplines which have three students") {
  //    val r = Raw.query(
  ...
  //  }
  //
  //  ignore("set of the number of students per department") {
  //    val r = Raw.query(
  ...
  //  ignore("set of names departments which have the highest number of students", ???, Set("dep1"))
  //  ignore("set of names departments which have the lowest number of students", ???, Set("dep2", "dep3"))
  //  ignore("set of profs which have the highest number of students in their department", ???, Set("Prof1"))
  //  ignore("set of profs which have the lowest number of students in their department", ???, Set("Prof2", "Prof3"))
  //  ignore("set of students who study 'Artificial Intelligence'", ???, Set("Student6", "Student7"))
}
